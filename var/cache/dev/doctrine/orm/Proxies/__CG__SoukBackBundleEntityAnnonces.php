 ...
 */
class Annonces extends \Souk\BackBundle\Entity\Annonces implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'id', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'titre', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'description', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'prix', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'disponible', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'dateCreation', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'categorie', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'images', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'commercial', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'commandes', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'commentaires', '' . "\0" . 'Souk\\BackBundle\\Entity\\Annonces' . "\0" . 'signals'];
        }
    ...
    public function getSignalsAnc()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSignalsAnc', []);

        return parent::getSignalsAnc();
    }
