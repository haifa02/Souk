 ...
 */
class Categories extends \Souk\BackBundle\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Souk\\BackBundle\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'Souk\\BackBundle\\Entity\\Categories' . "\0" . 'designation', '' . "\0" . 'Souk\\BackBundle\\Entity\\Categories' . "\0" . 'annonces'];
        }
